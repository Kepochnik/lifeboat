const dictionaries = {
  ru: {
    ...
    chooseAction: 'Выбери действие', choosePlayer: 'Выбери игрока', chooseCard: 'Выбери карту', confirm: 'Подтвердить', cancel: 'Отмена', decline: 'Отказаться', accept: 'Согласиться', fight: 'Драться', neutral: 'Не вмешиваться', supportAttacker: 'За нападающего', supportDefender: 'За защитника',
    ...
    sound: 'Звук', vibration: 'Вибрация', theme: 'Тема', language: 'Язык', dark: 'Ночная', light: 'Дневная', motion: 'Анимации', textSize: 'Крупный текст', home: 'Главное меню', changeTheme: 'Сменить тему', more: 'Ещё', toggleLog: 'Свернуть или раскрыть журнал',
    ...
    rulesCardsTitle: 'Карты и обмен', rulesCards: 'Сознательный персонаж может открыть карту в любой момент. Во время действий можно свободно обмениваться, кроме драки. Открытые оружия усиливают только владельца; ракетница после боя сбрасывается. Весло даёт дополнительную карту при гребле, компас — при навигации.',
    ...
    tutorialIntro: 'В каждой партии у тебя есть персонаж, тайный любимый и тайный враг.', tutorialDraft: 'На раздаче бери одну закрытую карту и передавай оставшиеся дальше по лодке.', tutorialAction: 'В свой ход можно грести, пересесть, ограбить, использовать особую карту или ничего не делать.', tutorialFight: 'Отказ от ограбления или пересадки начинает драку. Остальные выбирают сторону, защитник выигрывает ничью.', tutorialNav: 'На корме выбирают карту из стопки гребли. Затем считаются птицы, падения за борт и каждая отдельная жажда.', tutorialScore: 'После четвёртой птицы сложи выживание, любовь, гибель врага и сокровища. Даже погибший в лодке может победить.',
    ...
    chooseMugReward: 'Возьми открытую карту или случайную закрытую', randomHidden: 'Случайная закрытая', noTargetCards: 'У цели нет карт.',
  ...
  en: {
    ...
    chooseAction: 'Choose an action', choosePlayer: 'Choose a player', chooseCard: 'Choose a card', confirm: 'Confirm', cancel: 'Cancel', decline: 'Decline', accept: 'Accept', fight: 'Fight', neutral: 'Stay neutral', supportAttacker: 'Support attacker', supportDefender: 'Support defender',
    ...
    sound: 'Sound', vibration: 'Vibration', theme: 'Theme', language: 'Language', dark: 'Night', light: 'Day', motion: 'Animations', textSize: 'Large text', home: 'Main menu', changeTheme: 'Change theme', more: 'More', toggleLog: 'Collapse or expand log',
    ...
    rulesCardsTitle: 'Cards and trading', rulesCards: 'A conscious character may reveal a card at any time. Trade freely during Actions except during a fight. Revealed weapons support only their owner; a flare is discarded after fighting. An Oar adds a rowing card and a Compass adds a navigation choice.',
    ...
    tutorialIntro: 'Every player has a character, a secret loved one and a secret enemy.', tutorialDraft: 'During the draft, choose one hidden card and pass the rest toward the stern.', tutorialAction: 'On your turn, row, change seats, mug, use a special card or do nothing.', tutorialFight: 'Refusing a mug or seat change starts a fight. Others choose sides, and the defender wins ties.', tutorialNav: 'The stern chooses from the row stack. Then resolve birds, overboard effects and every separate thirst.', tutorialScore: 'At the fourth bird, add survival, love, a dead enemy and treasure. Even a corpse in the boat can win.',
    ...
    chooseMugReward: 'Take a face-up card or a random hidden one', randomHidden: 'Random hidden card', noTargetCards: 'The target has no cards.',
